...
#define IDXT(v,i,j,k) (v*lattice_nx*lattice_ny*lattice_nz + (i + (int)(c[v].x*time_step_dt))*lattice_ny*lattice_nz + (j + (int)(c[v].y*time_step_dt))*lattice_nz + (k + (int)(c[v].z*time_step_dt)))
